...
export function CreateModal() {
  ...
  // const { toast } = useToast(); // Removed hook usage
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-4 mt-4">
          ...
          <div className="space-y-2">
            ...
            >
              ...
              <SelectContent>
                <SelectItem key="active" value={CableModemStatus.Active}>Active</SelectItem>
                <SelectItem key="suspended" value={CableModemStatus.Suspended}>Suspended</SelectItem>
                <SelectItem key="provision" value={CableModemStatus.Provision}>Provision</SelectItem>
              </SelectContent>
            </Select>
            ...
            <Popover>
              ...
              <PopoverContent className="w-auto p-0" align="start">
                <Calendar
                  ...
                  onSelect={(date) => {
                    setValue(
                      CableModemFieldNames.VALID_SINCE,
